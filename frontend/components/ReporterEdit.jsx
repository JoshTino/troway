				...
				<div className="bg-white w-11/12 rounded-lg mt-3 px-6 py-3 shadow-lg">
					...
					<form className="mt-6" onSubmit={handleSubmit}>
						...
						<div className="mb-4">
							...
							<select name="category" required value={report?.category} onChange={handleChange} className="w-full font-nunito bg-gray-100 text-gray-700 border-1 border-green-300 p-4 outline-green-500 rounded-lg">
